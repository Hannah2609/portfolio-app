  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        hoverEffect:
          "bg-primary text-primary-foreground border-2 border-primary dark:border-primary shadow-xs hover:bg-transparent hover:border-2 dark:hover:border-white dark:hover:text-white hover:border-black hover:text-black",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "bg-transparrent text-primary-background dark:border-white shadow-xs hover:bg-transparent hover:border-2 dark:hover:border-white dark:hover:text-white hover:border-black hover:text-black",
        secondary:
